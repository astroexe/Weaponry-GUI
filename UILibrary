if game.CoreGui:FindFirstChild("NoxWareLib") then
    game.CoreGui.NoxWareLib:Destroy()
end
...
coroutine.wrap(
	function()
		while wait() do
			NoxWare.RainbowColorValue = NoxWare.RainbowColorValue + 1 / 255
			NoxWare.HueSelectionPosition = NoxWare.HueSelectionPosition + 1

			if NoxWare.RainbowColorValue >= 1 then
				NoxWare.RainbowColorValue = 0
			end

			if NoxWare.HueSelectionPosition == 93 then
				NoxWare.HueSelectionPosition = 0
			end
		end
	end
)()
...
NoxWareLib.Name = "NoxWareLib"
NoxWareLib.Parent = game.CoreGui
NoxWareLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
